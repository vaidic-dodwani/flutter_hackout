...
import 'package:flutter_hackout/utils/toast_functions.dart';
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: SingleChildScrollView(
        child: Consumer<ScrapViewModel>(builder: (_, ref, __) {
          return SizedBox(
            child: ref.loading
                ? const Center(
                    child:
                        ...
                        ElevatedButton(
                            ...
                            onPressed: () {
                              if (companyName.text.isEmpty) {
                                showErrorToast(
                                    context, "Company Name cannot be empty");
                                return;
                              } else if (keywords.text.isEmpty) {
                                showErrorToast(
                                    context, "Keywords cannot be empty");
                                return;
                              } else {
                                ref.scrap(
