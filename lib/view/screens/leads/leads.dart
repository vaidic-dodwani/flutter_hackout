...
import 'package:flutter_hackout/view/screens/leads/leads_detail/lead_detail.dart';
import 'package:flutter_hackout/view/screens/leads/widgets/leadwidget.dart';
        ...
        children: [
          ...
          Expanded(child: Consumer<LeadNotifier>(builder: (_, ref, __) {
            return ref.leads == null
                ...
                : ref.leads!.isEmpty
                    ? const Center(
                        child: Text("No Leads to be shown. Run the Scraper"),
                      )
                    : RefreshIndicator(
                                            ...
                                            lead: LeadModel(
                                                leadScore: ref.leads?[index]
                                                    ...
                                                    : int.parse(ref
                                                        ...
                                                        "0"),
                                                name:
                                                    ref.leads?[index].fullName,
                                                profileImage: ref.leads?[index]
                                                    .profileImageUrl,
                                                stage: ref.leads?[index]
                                                            .stateProgress ==
                                                        1
                                                    ? LeadStage.aware
                                                    : ref.leads?[index]
